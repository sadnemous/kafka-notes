#!/usr/bin/env python3
"""
Kafka Consumer #1 - Consumer Group: consumer-group-1

This consumer uses group ID 'consumer-group-1' and will track its own offsets.
Multiple instances of this consumer will share messages (load balancing).
"""
...
class KafkaConsumer1:
    def __init__(self, bootstrap_servers='localhost:9092'):
        ...
        self.topic = 'my-topic'
        self.group_id = 'consumer-group-1'  # Unique group ID
    ...
    def run(self):
        """Main consumer loop"""
        print("🚀 Starting Kafka Consumer #1...")
    ...
    def _cleanup(self):
        ...
        print("👋 Consumer #1 says goodbye!")


if __name__ == "__main__":
    print("=" * 60)
    print("        KAFKA CONSUMER #1 (Group: consumer-group-1)")
    print("=" * 60)
    
    consumer = KafkaConsumer1()
    consumer.run()
